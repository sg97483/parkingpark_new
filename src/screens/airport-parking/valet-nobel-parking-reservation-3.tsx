...
const ValetNobelParkingReservation3 = memo(
  (props: RootStackScreenProps<'ValetNobelParkingReservation3'>) => {
    ...
    const handleSubmit = () => {
      ...
      navigation.navigate(ROUTE_KEY.ValetNobelParkingReservation4, {
    ...
    return (
      <FixedContainer>
        <CustomHeader text="3단계. 예약일정 및 가격확인" />
        <ScrollView>
        ...
        <TouchableOpacity onPress={handleSubmit} style={styles.submitWrapper}>
          <CustomText string="예약결제" color={colors.white} family={FONT_FAMILY.SEMI_BOLD} />
        </TouchableOpacity>
      </FixedContainer>
    );
  },
...
export default ValetNobelParkingReservation3;
