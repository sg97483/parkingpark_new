...
const ValetParkingReservation2 = memo((props: RootStackScreenProps<'ValetParkingReservation2'>) => {
  ...
  const handleNext = () => {
    ...
    navigation.navigate(ROUTE_KEY.ValetParkingReservation3, {
  ...
  return (
    <FixedContainer>
      ...
      <ScrollView>
        ...
        <TitleWithIcon title="출국정보" subTitle="(인천공항 도착예정 시간)" />
        ...
        <TitleWithIcon title="입국정보" subTitle="(귀국후 짐찾고 나올 예정시간)" />
        <UsageHistoryMenuText
          title="입국일시"
          content={
            <View
...
export default ValetParkingReservation2;
