...
const DirectIndoorParkingAtIncheon = memo(
  (props: RootStackScreenProps<'DirectIndoorParkingAtIncheon'>) => {
    ...
    const loadParkingAtIncheon = async () => {
      ...
      const results = data.filtered("id IN {'70004','70010'}") as any;
      setData(results);
    };
...
export default DirectIndoorParkingAtIncheon;
