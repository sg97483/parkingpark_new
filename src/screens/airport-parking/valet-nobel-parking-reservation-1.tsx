...
const ValetNobelParkingReservation1 = memo(
  (props: RootStackScreenProps<'ValetNobelParkingReservation1'>) => {
    ...
    // 페이지 로드 시 parkingLot?.limitedNumber 로그 출력
    useEffect(() => {
      if (parkingLot?.limitedNumber !== undefined) {
        console.log('Parking Lot Limited Number:', parkingLot.limitedNumber);
      } else {
        console.log('Parking Lot Limited Number is not available.');
      }
    }, [parkingLot]);
      ...
      editUserInfo({
        ...
        .then(res => {
          if (res === '200') {
            ...
            navigation.navigate(ROUTE_KEY.ValetNobelParkingReservation2, {
    ...
    return (
      <FixedContainer>
        <CustomHeader text="고객정보 입력 및 확인사항" />
          ...
          <UsageHistoryMenuText
            ...
            content={
              <CustomText
                ...
                string={`1. 최소 출발 2일전에 예약해주셔야 서비스 이용이 가능합니다. \n\n2. 주차장 운영시간은 새벽4시부터 밤12시(자정)까지 운영합니다.
              \n(00:00~04:00 에는 입,출차 불가합니다. 당시간에는 이용이 불가능하오니 참고부탁드립니다. \n\n3. 성수기, 주말에는 입차차량이 많은편이라 최소 5~7일전에는 예약해주셔야합니다. `}
              />
            }
            isLastIndex
          />
...
export default ValetNobelParkingReservation1;
