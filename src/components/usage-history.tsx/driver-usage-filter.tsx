...
import {cacheDriverUsageHistoryFilter} from '~reducers/carpoolReducer';
import {useAppDispatch, useAppSelector} from '~store/storeHooks';
import {colors} from '~styles/colors';
import {heightScale1, scale1, widthScale1} from '~styles/scaling-utils';

export interface DriverUsageFilterRefs {
  show: () => void;
  hide: () => void;
}
...
const DriverUsageFilter = forwardRef<DriverUsageFilterRefs, Props>(({filterScrollRef}, ref) => {
  ...
  const [currentFilter, setCurrentFilter] = useState<UsageHistoryFilterModel>(driverUsageFilter);

  useEffect(() => {
    setCurrentFilter(driverUsageFilter);
  }, [driverUsageFilter]);
        ...
        <HStack style={styles.buttonGroupStyle}>
          ...
          <CustomButton
            onPress={() => {
              ...
              dispatch(cacheDriverUsageHistoryFilter(currentFilter));
...
export default memo(DriverUsageFilter);
