    ...
    <View style={style}>
      <View style={styles.view}>
        <CustomText
          ...
          size={FONT.SUB_HEAD}
          color={isDisable ? colors.grayText : colors.black}
        />
...
export default SwitchButtonBottom;

const styles = StyleSheet.create({
  view: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    height: isIPad ? 150 : heightScale(70), // 아이패드인 경우 150, 그 외에는 heightScale(70)을 사용합니다.
