...
const CustomPositionSearch = forwardRef((props: Props, ref: Ref<TextInput>) => {
  const {
    type = 'DELETE_TEXT',
  ...
  }, [type, value, handleDeleteText, onPressMinus, onPressAdd]);
...
export default memo(CustomPositionSearch);
